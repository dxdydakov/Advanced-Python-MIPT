...
class Complex(object):
    ...
    def to_alg(self):
        # Принимает на вход 2 параметра, которым сооответствует модуль комплексного числа и его угол на комплексной плоскости.
        # Ставит в соответствие комплексное число из нашего класса, вычислив его действительную и мнимую части.
